...
'<div class="p-search_navi">' +
	'<h2>「{{query}}」の検索結果</h2>' +
	'<p><span>{{total}}</span>件 ： {{start}}～{{end}}件目を表示</p>' +
	'<!--<ul>' +
		'<li id="ss-sort-match" class="{{sortMatchSelected}}"><span>一致順</span></li>' +
		'<li id="ss-sort-date" class="{{sortDateSelected}}"><span>日付順</span></li>' +
	'</ul>-->' +
'</div>';
